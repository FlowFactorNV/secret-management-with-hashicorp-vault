...
- [4. Application cluster (EKS-application)](#4-application-cluster-eks-application)
- [5. Tooling cluster (EKS-tooling)](#5-tooling-cluster-eks-tooling)
- [6. In-depth look at the tools used](#6-in-depth-look-at-the-tools-used)
  * [6.1 Terraform (Infrastructure as Code)](#61-terraform-infrastructure-as-code)
    + [6.1.1 Terraform - What is it?](#611-terraform---what-is-it)
    + [6.1.2 Terraform - How does it work?](#612-terraform---how-does-it-work)
    + [6.1.3 Terraform - Why was it chosen?](#613-terraform---why-was-it-chosen)
    + [6.1.4 Terraform - How was it implemented?](#614-terraform---how-was-it-implemented)
    + [6.1.5 Terraform - Advantages](#615-terraform---advantages)
    + [6.1.6 Terraform - Disadvantages](#616-terraform---disadvantages)
  * [6.2 Helm](#62-helm)
    + [6.2.1 Helm - What is it?](#621-helm---what-is-it)
    + [6.2.2 Helm - Components of Helm](#622-helm---components-of-helm)
    + [6.2.3 Helm - How does it work?](#623-helm---how-does-it-work)
    + [6.2.4 Helm - Why was it chosen?](#624-helm---why-was-it-chosen)
    + [6.2.5 Helm - How was it implemented?](#625-helm---how-was-it-implemented)
    + [6.2.6 Helm - Advantages](#626-helm---advantages)
    + [6.2.7 Helm - Disadvantages](#627-helm---disadvantages)
  * [6.3 GitOps (FluxCD)](#63-gitops--fluxcd)
    + [6.3.1 FluxCD - What is it?](#631-fluxcd---what-is-it)
    + [6.3.2 FluxCD - Components of FluxCD](#632-fluxcd---components-of-fluxcd)
    + [6.3.3 FluxCD - How does it work?](#633-fluxcd---how-does-it-work)
    + [6.3.4 FluxCD - Why was it chosen?](#634-fluxcd---why-was-it-chosen)
    + [6.3.5 FluxCD - How was it implemented?](#635-fluxcd---how-was-it-implemented)
    + [6.3.6 FluxCD - Advantages](#636-fluxcd---advantages)
    + [6.3.7 FluxCD - Disadvantages](#637-fluxcd---disadvantages)
  * [6.4 - Self-hosted GitLab runner](#64---self-hosted-gitlab-runner)
    + [6.4.1 GitLab runner - What is it?](#641-gitlab-runner---what-is-it)
    + [6.4.2 GitLab runner - Components of Gitlab Runner](#642-gitlab-runner---components-of-gitlab-runner)
    + [6.4.3 GitLab runner - How does it work?](#643-gitlab-runner---how-does-it-work)
    + [6.4.4 GitLab runner - Why was it chosen?](#644-gitlab-runner---why-was-it-chosen)
    + [6.4.5 GitLab runner - How was it implemented?](#645-gitlab-runner---how-was-it-implemented)
    + [6.4.6 GitLab runner - Alternatives](#646-gitlab-runner---alternatives)
    + [6.4.7 GitLab runner - Advantages](#647-gitlab-runner---advantages)
    + [6.4.8 GitLab runner - Disadvantages](#648-gitlab-runner---disadvantages)
  * [6.5 Service Mesh (Istio)](#65-service-mesh--istio)
    + [6.5.1 Istio - What is it?](#651-istio---what-is-it)
    + [6.5.2 Istio - Components of Istio](#652-istio---components-of-istio)
    + [6.5.3 Istio - How does it work?](#653-istio---how-does-it-work)
    + [6.5.3 Istio - Why was it chosen?](#653-istio---why-was-it-chosen)
    + [6.5.4 Istio - How was it implemented?](#654-istio---how-was-it-implemented)
    + [6.5.5 Istio - Advantages](#655-istio---advantages)
    + [6.5.6 Istio - Disadvantages](#656-istio---disadvantages)
    + [6.5.7 Istio - Alternatives](#657-istio---alternatives)
  * [6.6 HashiCorp Vault](#66-hashicorp-vault)
    + [6.6.7 HashiCorp Vault - What is it?](#667-hashicorp-vault---what-is-it)
    + [6.6.8 HashiCorp Vault - Components of Vault](#668-hashicorp-vault---components-of-vault)
    + [6.6.8 HashiCorp Vault - How does it work?](#668-hashicorp-vault---how-does-it-work)
    + [6.6.9 HashiCorp Vault - Why was it chosen?](#669-hashicorp-vault---why-was-it-chosen)
    + [6.6.10 HashiCorp Vault - How was it implemented?](#6610-hashicorp-vault---how-was-it-implemented)
    + [6.6.11 HashiCorp Vault - Advantages](#6611-hashicorp-vault---advantages)
    + [6.6.12 HashiCorp Vault - Vault agent flow](#6612-hashicorp-vault---vault-agent-flow)
    + [6.6.13 HashiCorp Vault - Database engine flow](#6613-hashicorp-vault---database-engine-flow)
  * [6.7 External Secret Operator](#67-external-secret-operator)
    + [6.7.1 External Secret Operator - What is the problem?](#671-external-secret-operator---what-is-the-problem)
    + [6.7.2 External Secret Operator - What is the solution?](#672-external-secret-operator---what-is-the-solution)
- [7. User scenario: external access to Vault](#7-user-scenario--external-access-to-vault)
  * [7.1 Network Load Balancer (NLB)](#71-network-load-balancer--nlb)
    + [7.1.1 Network Load Balancer - What is it?](#711-network-load-balancer---what-is-it)
    + [7.1.2 Network Load Balancer - How does it work?](#712-network-load-balancer---how-does-it-work)
    + [7.1.3 Network Load Balancer - Why was it chosen?](#713-network-load-balancer---why-was-it-chosen)
    + [7.1.4 Network Load Balancer - How was it implemented?](#714-network-load-balancer---how-was-it-implemented)
    + [7.1.5 Network Load Balancer - Advantages](#715-network-load-balancer---advantages)
    + [7.1.6 Network Load Balancer - Disadvantages](#716-network-load-balancer---disadvantages)
  * [7.2 Network Load Balancer - Target group and health check](#72-network-load-balancer---target-group-and-health-check)
  * [7.3 Route 53 Private Hosted Zone](#73-route-53-private-hosted-zone)
    + [7.3.1 Route 53 Private Hosted Zone - What is it?](#731-route-53-private-hosted-zone---what-is-it)
    + [7.3.1 Route 53 Private Hosted Zone - Why was it chosen?](#731-route-53-private-hosted-zone---why-was-it-chosen)
    + [7.3.1 Route 53 Private Hosted Zone - How was it implemented?](#731-route-53-private-hosted-zone---how-was-it-implemented)
    + [7.3.2 Route 53 Private Hosted Zone - Advantages](#732-route-53-private-hosted-zone---advantages)
    + [7.3.3 Route 53 Private Hosted Zone - Disadvantages](#733-route-53-private-hosted-zone---disadvantages)
  * [7.4 VPN](#74-vpn)
    + [7.4.1 VPN - What is it?](#741-vpn---what-is-it)
    + [7.4.2 VPN - Why was it chosen?](#742-vpn---why-was-it-chosen)
    + [7.4.3 VPN - How was it implemented?](#743-vpn---how-was-it-implemented)
- [8. Installation Guide](#8-installation-guide)
  * [8.1 Requirements](#81-requirements)
  * [8.2 Cloning the infrastructure repository](#82-cloning-the-infrastructure-repository)
  * [8.3 Terraform initialization](#83-terraform-initialization)
  * [8.4 GitOps-automation via FluxCD](#84-gitops-automation-via-fluxcd)
  * [8.5 Vault recovery on first bootstrap](#85-vault-recovery-on-first-bootstrap)
  * [8.6 GitLab-runner setup](#86-gitlab-runner-setup)
  * [8.7 VPN Configuration (for external access to Vault)](#87-vpn-configuration--for-external-access-to-vault)
  * [8.8 Overview of the Deployment Flow](#88-overview-of-the-deployment-flow)
  * [8.9 Result](#89-result)
- [9. Technical conclusion](#9-technical-conclusion)
