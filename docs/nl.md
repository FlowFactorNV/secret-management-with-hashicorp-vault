...
- [3. AWS-infrastructuur](#3-aws-infrastructuur)
- [4. Applicatie cluster (EKS-applicatie)](#4-applicatie-cluster-eks-applicatie)
- [5. Tooling cluster (EKS-tooling)](#5-tooling-cluster-eks-tooling)
- [6. Verdieping op de gebruikte tools](#6-verdieping-op-de-gebruikte-tools)
  * [6.1 Terraform (Infrastructure as Code)](#61-terraform-infrastructure-as-code)
    + [6.1.1 Terraform - Wat is het?](#611-terraform---wat-is-het)
    + [6.1.2 Terraform - How werkt het?](#612-terraform---how-werkt-het)
    + [6.1.3 Terraform - Waarom gekozen?](#613-terraform---waarom-gekozen)
    + [6.1.4 Terraform - Hoe geïmplementeerd?](#614-terraform---hoe-ge-mplementeerdt)
    + [6.1.5 Terraform - Voordelen](#615-terraform---voordelen)
    + [6.1.6 Terraform - Nadelen](#616-terraform---nadelen)
  * [6.2 Helm](#62-helm)
    + [6.2.1 Helm - Wat is het?](#621-helm---wat-is-het)
    + [6.2.2 Helm - Onderdelen van Helm](#622-helm---onderdelen-van-helm)
    + [6.2.3 Helm - Hoe werkt het?](#623-helm---hoe-werkt-het)
    + [6.2.4 Helm - Waarom gekozen?](#624-helm---waarom-gekozen)
    + [6.2.5 Helm - Hoe geïmplementeerd?](#625-helm---hoe-ge-mplementeerd)
    + [6.2.6 Helm - Voordelen](#626-helm---voordelen)
    + [8.2.7 Helm - Nadelen](#827-helm---nadelen)
  * [6.3 GitOps (FluxCD)](#63-gitops--fluxcdt)
    + [6.3.1 FluxCD - Wat is het?](#631-fluxcd---wat-is-het)
    + [6.3.2 FluxCD - Onderdelen van FluxCD](#632-fluxcd---onderdelen-van-fluxcd)
    + [6.3.3 FluxCD - Hoe werkt het?](#633-fluxcd---hoe-werkt-het)
    + [6.3.4 FluxCD - Waarom gekozen?](#634-fluxcd---waarom-gekozen)
    + [6.3.5 FluxCD - Hoe geïmplementeerd?](#635-fluxcd---hoe-ge-mplementeerd)
    + [6.3.6 FluxCD - Voordelen](#636-fluxcd---voordelen)
    + [6.3.7 FluxCD - Nadelen](#637-fluxcd---nadelen)
  * [6.4 - Self-hosted GitLab runner](#64---self-hosted-gitlab-runner)
    + [6.4.1 GitLab runner - Wat is het?](#641-gitlab-runner---wat-is-het)
    + [6.4.2 GitLab runner - Onderdelen van Gitlab Runner](#642-gitlab-runner---onderdelen-van-gitlab-runner)
    + [6.4.3 GitLab runner - Hoe werkt het?](#643-gitlab-runner---hoe-werkt-het)
    + [6.4.4 GitLab runner - Waarom gekozen?](#644-gitlab-runner---waarom-gekozen)
    + [6.4.5 GitLab runner - Hoe geïmplementeerd?](#645-gitlab-runner---hoe-ge-mplementeerd)
    + [6.4.6 GitLab runner - Alternatieven](#646-gitlab-runner---alternatieven)
    + [6.4.7 GitLab runner - Voordelen](#647-gitlab-runner---voordelen)
    + [6.4.8 GitLab runner - Nadelen](#648-gitlab-runner---nadelen)
  * [6.5 Service Mesh (Istio)](#65-service-mesh--istio)
    + [6.5.1 Istio - Wat is het?](#651-istio---wat-is-het)
    + [6.5.2 Istio - Onderdelen van Istio](#652-istio---onderdelen-van-istio)
    + [6.5.3 Istio - Hoe werkt het?](#653-istio---hoe-werkt-het)
    + [6.5.3 Istio - Waarom gekozen?](#653-istio---waarom-gekozen)
    + [6.5.4 Istio - Hoe geïmplementeerd?](#654-istio---hoe-ge-mplementeerd)
    + [6.5.5 Istio - Voordelen](#655-istio---voordelen)
    + [6.5.6 Istio - Nadelen](#656-istio---nadelen)
    + [6.5.7 Istio - Alternatieven](#657-istio---alternatieven)
  * [6.6 HashiCorp Vault](#66-hashicorp-vault)
    + [6.6.7 HashiCorp Vault - Wat is het?](#667-hashicorp-vault---wat-is-het)
    + [6.6.8 HashiCorp Vault - Onderdelen van Vault](#668-hashicorp-vault---onderdelen-van-vault)
    + [6.6.8 HashiCorp Vault - Hoe werkt het?](#668-hashicorp-vault---hoe-werkt-het)
    + [6.6.9 HashiCorp Vault - Waarom gekozen?](#669-hashicorp-vault---waarom-gekozen)
    + [6.6.10 HashiCorp Vault - Hoe geïmplementeerd?](#6610-hashicorp-vault---hoe-ge-mplementeerd)
    + [6.6.11 HashiCorp Vault - Voordelen](#6611-hashicorp-vault---voordelen)
  ...
  * [6.7 External Secret Operator](#67-external-secret-operator)
    + [6.7.1 External Secret Operator - Wat is het probleem?](#671-external-secret-operator---wat-is-het-probleem)
    + [6.7.2 External Secret Operator - Wat is de oplossing?](#672-external-secret-operator---wat-is-de-oplossing)
- [7. Gebruikersscenario: externe toegang tot Vault](#7-gebruikersscenario-externe-toegang-tot-vault)
  * [7.1 Network Load Balancer (NLB)](#71-network-load-balancer--nlb)
    + [7.1.1 Network Load Balancer - Wat is het?](#711-network-load-balancer---wat-is-het)
    + [7.1.2 Network Load Balancer - Hoe werkt het?](#712-network-load-balancer---hoe-werkt-het)
    + [7.1.3 Network Load Balancer - Waarom gekozen?](#713-network-load-balancer---waarom-gekozen)
    + [7.1.4 Network Load Balancer - Hoe geïmplementeerd?](#714-network-load-balancer---hoe-ge-mplementeerd)
    + [7.1.5 Network Load Balancer - Voordelen](#715-network-load-balancer---voordelen)
    + [7.1.6 Network Load Balancer - Nadelen](#716-network-load-balancer---nadelen)
  * [7.2 Network Load Balancer - Target group en health check](#72-network-load-balancer---target-group-en-health-check)
  * [7.3 Route 53 Private Hosted Zone](#73-route-53-private-hosted-zone)
    + [7.3.1 Route 53 Private Hosted Zone - Wat is het?](#731-route-53-private-hosted-zone---wat-is-het)
    + [7.3.1 Route 53 Private Hosted Zone - Waarom gekozen?](#731-route-53-private-hosted-zone---waarom-gekozen)
    + [7.3.1 Route 53 Private Hosted Zone - Hoe geïmplementeerd?](#731-route-53-private-hosted-zone---hoe-ge-mplementeerd)
    + [7.3.2 Route 53 Private Hosted Zone - Voordelen](#732-route-53-private-hosted-zone---voordelen)
    + [7.3.3 Route 53 Private Hosted Zone - Nadelen](#733-route-53-private-hosted-zone---nadelen)
  * [7.4 VPN](#74-vpn)
    + [7.4.1 VPN - Wat is het?](#741-vpn---wat-is-het)
    + [7.4.2 VPN - Waarom gekozen?](#742-vpn---waarom-gekozen)
    + [7.4.3 VPN - Hoe geïmplementeerd?](#743-vpn---hoe-ge-mplementeerd)
- [8. Installatiehandleiding](#8-installatiehandleiding)
  * [8.1 Vereisten](#81-vereisten)
  * [8.2 Clonen van de infrastructuur repository](#82-clonen-van-de-infrastructuur-repository)
  * [8.3 Terraform initialisatie](#83-terraform-initialisatie)
  * [8.4 GitOps-automatisering via FluxCD](#84-gitops-automatisering-via-fluxcd)
  * [8.5 Vault recovery bij eerste bootstrap](#85-vault-recovery-bij-eerste-bootstrap)
  * [8.6 GitLab-runner instellen](#86-gitlab-runner-instellen)
  * [8.7 VPN Configuratie (voor externe toegang tot Vault)](#87-vpn-configuratie--voor-externe-toegang-tot-vault)
  * [8.8 Overzicht van de Deployment Flow](#88-overzicht-van-de-deployment-flow)
  * [8.9 Resultaat](#89-resultaat)
- [9. Technische conclusie](#9-technische-conclusie)
